...
class Program
{
    static void Main(string[] args)
    {
        ...
        if (Directory.Exists(directoryPath))
        {
            ...
            try
            {
                List<string> filePathes = FilesIoHelper.Instance.GetFiles(directoryPath).ToList();
                filePathes.ForEach(filePath => files.Add(FilesIoHelper.Instance.GetFileMetadata(filePath)));
            }
